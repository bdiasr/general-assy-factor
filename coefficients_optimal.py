...
def A_mn_Parallel(n, M, x, v,alpha1, rho_0, phi_0, x_0, y_0, z_0):
...
for ni in range(0, 31):
    print("Para tamanho de particula x=", ni, " temos n_max=",n_max(ni))



def TestCoeff_Amn_Parallel():
    ...
    for i in zval:
        print("i:", cnt)
        #jn1_gauss_blue.append(j_FW_Parallel(epsilonR2(M, mi), M, 0.1, i, mi, k))
